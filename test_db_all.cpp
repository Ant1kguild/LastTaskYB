...
void TestDataBasePerf() {
    Database db;
    const auto date = Date(1, 1, 1);
    string event;
    auto start = std::chrono::high_resolution_clock::now();
    for (auto i = 0; i < 1000000; i++) {
        db.Add(date, random_string(5));
    }
    auto gen = std::bind(std::uniform_int_distribution<>(0, 1), std::default_random_engine());
    auto alwaysFalse = [&](const Date &, const string &) { return gen(); };
    //db.RemoveIf(alwaysFalse);
...
void TestDataBaseCondition() {
    {
        //Add
        {
            ...
            JUnit::AssertEqual(received, expected, "Add(), direct date insertion");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Add(), direct date insertion, add several unique events");
        }
        {
            ...
            JUnit::AssertEqual(received, expected, "Add(), random date insertion, add several unique events");
        }
        {
            const string scenario = "Add 2017-11-21 event0\n  \
                                      Add 2017-11-20 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Add(), random date insertion, add several random events");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
        ...
        }
        {
            ...
            JUnit::AssertEqual(received, expected, "Add(), events "" ");
        }
    }
    {
        //Print
        {
            ...
            JUnit::AssertEqual(received, expected, "Print(), no events");
        }
    }
    {
        //Remove
        {
            ...
            JUnit::AssertEqual(received, expected, "Del(), date  > condition");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
        ...
        }
        {
            ...
            JUnit::AssertEqual(received, expected, "Del(), date == condition, from list middle");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Del(), date == condition, from list beginning");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Del(), date == condition, from list end");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
        ...
        }
        {
            ...
            JUnit::AssertEqual(received, expected, "Del(), event != condition, single mentioned");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Del(), event != condition, many times mentioned");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
        ...
        }
        {
            ...
            JUnit::AssertEqual(received, expected, "Del(), no condition");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Del(), combined AND condition");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Del(), combined OR condition");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Del(), combined with brackets");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
    ...
    }
    {
        //Find
        {
            ...
            JUnit::AssertEqual(received, expected, "Find(), date  > condition");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
        ...
        }
        {
            ...
            JUnit::AssertEqual(received, expected, "Find(), date == condition, from list middle");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Find(), date == condition, from list beginning");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Find(), date == condition, from list end");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
        ...
        }
        {
            ...
            JUnit::AssertEqual(received, expected, "Find(), event != condition, single mentioned");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Find(), event != condition, many times mentioned");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
        ...
        }
        {
            ...
            JUnit::AssertEqual(received, expected, "Find(), no condition");
        }
        {
            ...
            JUnit::AssertEqual(received, expected, "Find(), no condition, empty box");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Find(), combined AND condition");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Find(), combined OR condition");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Find(), combined with brackets");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
    ...
    }
    {
        //Last
        {
            ...
            JUnit::AssertEqual(received, expected, "Last(), empty box");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Last(), data before db beginning");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Last(), first single db item");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Last(), request to the middle");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                                      Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Last(), request to the end");
        }
        {
            ...
            JUnit::AssertEqual(received, expected, "Last(), empty date #1");
        }
        {
            const string scenario = "Add 2017-11-20 event0\n  \
                    Add 2017-11-21 event1\n  \
            ...
            JUnit::AssertEqual(received, expected, "Last(), empty date #2");
        }
        {
            const string scenario = "Last 2017-11-20\n \
                    Last\n \
                    Add 2017-11-20 event0\n \
                    Add 2017-11-21 event3\n  \
                    Add 2017-11-21 event2\n  \
                    Add 2017-11-21 event3\n  \
                    Add 2017-11-21  \n  \
                    Last 2017-11-21\n        \
            ...
            JUnit::AssertEqual(received, expected, "Last(), empty date #3");
        }
    }
}